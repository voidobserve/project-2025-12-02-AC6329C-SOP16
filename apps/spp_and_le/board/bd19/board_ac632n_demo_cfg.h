...
//                                 2.4G key 配置                                        //
//*********************************************************************************//
#define TCFG_RF24GKEY_ENABLE			    ENABLE_THIS_MOUDLE //是否使能IO按键
...
//亮度控制， 精科达使用
// #define TCFG_IOKEY_BRIGHT_CONNECT_WAY		ONE_PORT_TO_LOW   //按键一端接低电平一端接IO
// #define TCFG_IOKEY_BRIGHT_ONE_PORT			IO_PORTB_07
...
#define TCFG_ADKEY_AD1      (0x3ffL )     //3k
#define TCFG_ADKEY_AD2      (0x3ffL )     //6.2k
#define TCFG_ADKEY_AD3      (0x3ffL )     //9.1k
